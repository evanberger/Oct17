...
},{"invariant":9,"react":6}],2:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || function (d, b) {
    for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
    function __() { this.constructor = d; }
    ...
    return function wrapWithApolloComponent(WrappedComponent) {
        ...
        var GraphQL = (function (_super) {
            ...
            GraphQL.prototype.createQuery = function (opts) {
                ...
                if (!opts.forceFetch && this.type !== parser_1.DocumentType.Subscription) {
            ...
            GraphQL.prototype.subscribeToQuery = function (props) {
                ...
                var next = function (results) {
                    ...
                    var data = results.data, loading = results.loading, error = results.error;
...
},{"apollo-client":6,"invariant":9}],5:[function(require,module,exports){
"use strict";
